...
describe('webapp/fleet/existinguser/fleet-administrator/admin-save,deny,approve-and-as-driver-schedule.cy.ts', () => {
    ...
    it('1. login as admin then Save and Deny quote', () => {
        loginPage.loginThroughCustomCredentials(fleet.migratedFleetadmin, fleet.migratedFleetPassword);
        servicesPage.verifyFleetDashboardPage();
    ...
    it('2. login as admin then Save and Approve quote and login as driver schedule a requested quote', () => {
        loginPage.loginThroughCustomCredentials(fleet.migratedFleetadmin, fleet.migratedFleetPassword);
        servicesPage.verifyFleetDashboardPage();
        quotesPage.navigateToFleetQuotesPageAndVerify();
        quotesPage.serviceDescriptionInApproveTab().then(($serviceName) => {
    ...
    it('3. login as admin and Deny quote', () => {
        loginPage.loginThroughCustomCredentials(fleet.migratedFleetadmin, fleet.migratedFleetPassword);
        servicesPage.verifyFleetDashboardPage();
        quotesPage.navigateToFleetQuotesPageAndVerify();
        quotesPage.serviceDescriptionInApproveTab().then(($serviceName) => {
