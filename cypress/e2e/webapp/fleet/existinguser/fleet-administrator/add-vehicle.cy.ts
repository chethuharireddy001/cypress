...
describe('webapp/fleet/existinguser/fleet-administrator/add-vehicle.cy.ts', () => {
    ...
    it('1. Add vehicle via make, model, year enter mileage', () => {
        ...
        fleetPage.selectYourRegion(fleet.Region2).click();
        fleetPage.hubDropDown().click();
        fleetPage.selectYourHub(fleet.Region2Hub2).click();
    ...
    it('2. add vehicle via license', () => {
        ...
        fleetPage.selectYourRegion(fleet.Region2).click();
        fleetPage.hubDropDown().click();
        fleetPage.selectYourHub(fleet.Region2Hub1).click();
        fleetPage.minionMileage().type(vehicle.mileage);
        fleetPage.footerNextButton().click();
        fleetPage.refreshVehiclePage();
    ...
    if (getfeatures().addVehicleViaVIN) {
        it('3. Add vehicle via VIN, assign to a hub', () => {
            ...
            fleetPage.assignVehicleToDefferenttHub(fleet.Region2, fleet.Region2Hub1 );
    ...
    it('4. filter vehicle by Regions, hubs and vehicle make', () => {
        ...
        fleetPage.selectYourHub(fleet.Region2Hub2).click({ force: true });
        fleetPage.checkbox().should('have.length', fleet.vehicleCountInRegion2Hub2);
